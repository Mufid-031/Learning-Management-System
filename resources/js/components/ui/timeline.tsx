        ...
        >
            <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10 relative">
                ...
                <motion.h2
                    ...
                    className="text-2xl md:text-4xl mb-4 text-black dark:text-white text-center"
                >
                    {heading}
                </motion.h2>
                <motion.p
                    ...
                    className="text-neutral-700 dark:text-muted-foreground text-sm md:text-base text-center px-2 lg:px-60"
                >
                    {description}
                </motion.p>
            </div>
